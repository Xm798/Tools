...
// https://gitee.com/Rokukkkk/resin-checker-shortcuts/blob/main/resin.js
...
async function createWidget() {
  ...
  widget.addSpacer(8);
  // Show data
  let nameElement = widget.addText(resin[0] + "/160");
  ...
  if (!config.runsWithSiri) {
    ...
    linkStack.url =
      "shortcuts://run-shortcut?name=%E6%A0%91%E8%84%82%E6%9F%A5%E8%AF%A2";
    let linkElement = linkStack.addText("树脂查询");
...
async function getClock() {
  ...
  let timeRecovery = new Date(timeNow + resin[1] * 1000);
